...
<div class="container">
  ...
  <form class="form-horizontal" action="<%=request.getContextPath()%>/RegisterAdmin" method="post">
	...
	<div class="form-group">
		...
		<div class="col-sm-4">
			<input type="text" class="form-control" id="role" value="Admin" name="role" readonly>
		</div>
		<label class="control-label col-sm-4" ></label>
    </div>
